...
public final class MixinService extends MixinServiceAbstract implements IClassProvider, IClassBytecodeProvider {
    ...
    public InputStream getResourceAsStream(String name) {
        ...
        try {
            ...
            if (names.length == 2) {
                JarFile jar = MohistKite.getPluginLoader().getPluginJar(names[0]);
            ...
            InputStream is = MohistKiteAgent.getResourceAsStream(name);
    ...
    protected ILogger createLogger(String name) {
        Logger logger = MohistKiteLogger.getLogger(name);
    ...
    public ClassNode getClassNode(String name, boolean runTransformers) throws ClassNotFoundException {
        ...
        try {
            byte[] classBytes = MohistKiteAgent.getClassAsByteArray(name);
